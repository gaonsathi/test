...
(function () {
  ...
  function build(){
    ...
    o.innerHTML=`
      ...
      <div class="gs-brand-layer" aria-hidden="true">
        <div class="gs-brand-topcenter">
          <div class="gs-jnv-logo">
            <svg viewBox="0 0 100 100" width="70" height="70" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <linearGradient id="gsJnvRing" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stop-color="#f4d27a"/><stop offset="45%" stop-color="#fffbe6"/><stop offset="100%" stop-color="#8a5c15"/>
                </linearGradient>
              </defs>
              <circle cx="50" cy="50" r="45" fill="none" stroke="url(#gsJnvRing)" stroke-width="3"/>
              <circle cx="50" cy="50" r="37" fill="none" stroke="url(#gsJnvRing)" stroke-width="1.2" stroke-dasharray="2 3"/>
              <path d="M14 58 Q22 30 44 20 Q30 40 30 62 Q22 62 14 58Z" fill="url(#gsJnvRing)" opacity=".85"/>
              <path d="M86 58 Q78 30 56 20 Q70 40 70 62 Q78 62 86 58Z" fill="url(#gsJnvRing)" opacity=".85"/>
              <text x="50" y="49" text-anchor="middle" font-family="'Baloo 2',sans-serif" font-weight="800" font-size="20" fill="url(#gsJnvRing)">JNV</text>
              <text x="50" y="66" text-anchor="middle" font-family="Inter,sans-serif" font-weight="700" font-size="7" letter-spacing="1" fill="url(#gsJnvRing)">SIWAN</text>
            </svg>
          </div>
          <span class="gs-brand-caption" data-en="Jawahar Navodaya Vidyalaya">जवाहर नवोदय विद्यालय</span>
        </div>

        <div class="gs-brand-topright">
          <div class="gs-pmshree-logo">
            <svg viewBox="0 0 100 100" width="56" height="56" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <linearGradient id="gsPmRing" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stop-color="#f4d27a"/><stop offset="45%" stop-color="#fffbe6"/><stop offset="100%" stop-color="#8a5c15"/>
                </linearGradient>
              </defs>
              <polygon points="50,6 61,38 95,38 68,58 78,90 50,70 22,90 32,58 5,38 39,38"
                fill="none" stroke="url(#gsPmRing)" stroke-width="3" stroke-linejoin="round"/>
              <text x="50" y="55" text-anchor="middle" font-family="'Baloo 2',sans-serif" font-weight="800" font-size="15" fill="url(#gsPmRing)">PM</text>
              <text x="50" y="68" text-anchor="middle" font-family="Inter,sans-serif" font-weight="700" font-size="7" letter-spacing="1" fill="url(#gsPmRing)">SHREE</text>
            </svg>
          </div>
        </div>

        <div class="gs-brand-right">
          <b class="gs-brand-premium">PM SHREE<br>JAWAHAR NAVODAYA<br>VIDYALAYA SIWAN</b>
        </div>
  ...
  function runGrandOpening(overlay){
    ...
    const begin=()=>{
      ...
      // PM SHREE logo, school name) vanishes with its own animation first.
