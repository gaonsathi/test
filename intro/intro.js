...
(function () {
  ...
  function build(){
    ...
    o.innerHTML=`
      ...
      <div class="gs-curtain-banner"><span class="gs-banner-rule"></span><b>Waiting for Our Respected Principal Sir</b><span class="gs-banner-rule"></span></div>
    `;
    return o;
  }
  function ensureHome(){
  ...
  function showLocked(overlay, badKey){
    ...
    msg.innerHTML = `
      ...
      <b data-en="Waiting to be inaugurated">उद्घाटन की प्रतीक्षा है</b>
      <span data-en="This will open at the ceremony">यह उद्घाटन समारोह में खुलेगा</span>
  ...
  // visitor's own tap and a live broadcast overlap.
        ...
        if(vData.valid){
          showReadyToOpen(overlay, async (msgEl)=>{
            try{
              ...
              if(uRes.ok){ msgEl.remove(); runGrandOpening(overlay); return; }
