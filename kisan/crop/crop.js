...

{
  ...
  // ---------------------------------------------------------
  function lvWsUrl(){
    // Live Voice runs on its own dedicated server (LIVE_PORT).
    // Set window.GAON_SATHI_LIVE_BASE in index.html to point at that
    // server (e.g. "https://gaonsathi-live.onrender.com").
    // Falls back to AI_PROXY_BASE for local dev where both share one port.
